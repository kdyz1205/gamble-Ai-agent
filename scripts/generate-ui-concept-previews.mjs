...
${theme}
</style></head><body><main class="screen"><div class="top"><div class="brand"><div class="logo">A</div><span>stubborn</span></div><div class="tag">${title}</div></div>${body}<div style="position:absolute;right:38px;bottom:24px;color:#94A3B8;font-size:12px;font-weight:800">${thesis}</div></main></body></html>`;
}
...
<section style="display:grid;grid-template-columns:1fr 420px;gap:28px;height:760px">
  ...
  <aside class="card" style="padding:24px;background:#F8FAFC;color:#111827">
    ...
    <p class="thesis">“I am Kevin on the left. Jerry is on the right. stubborn start.”</p>
...
<section style="display:grid;grid-template-columns:520px 1fr;gap:44px;align-items:center;height:760px">
  <div>
    <h1>Less text.<br/>One choice.</h1><p class="thesis">Instead of dumping rules, stubborn shows a stack: who, proof, identity, judge, settle.</p>
  </div>
