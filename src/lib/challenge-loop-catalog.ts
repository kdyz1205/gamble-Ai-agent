...
export const CERTIFIED_CHALLENGE_LOOPS: ChallengeLoopCatalogItem[] = [
  ...
  },
  {
    ...
    proof: "needs screenshot fixture E2E",
    successCriteria: [
      "Opponent accepts.",
      "Both submit screenshots.",
      "Judge verifies timer, words, and score before settlement.",
    ],
  },
  {
    id: "study-streak",
    ...
    status: "manual_review_only",
    participantMode: "head_to_head",
    evidenceMode: "manual_review",
    proof: "needs multi-day deadline E2E",
    successCriteria: [
      "Daily proof window is explicit.",
      "Missed submissions do not auto-settle incorrectly.",
      "Manual review handles ambiguous proof.",
    ],
  },
  {
    id: "nearby-check-in",
    ...
    status: "guardrail_proven",
    participantMode: "small_group",
    evidenceMode: "gps",
    proof: "scripts/e2e-radar-location-flow.mjs",
    successCriteria: [
      "Browser location can be requested.",
      "Nearby challenges can be discovered.",
      "Precise stranger location is not exposed.",
    ],
  },
  {
    ...
    participantMode: "head_to_head",
    evidenceMode: "screenshot",
    proof: "needs screenshot score E2E",
    successCriteria: [
      "Both screenshots are tied to the challenge.",
      "Score and player identity are visible.",
      "Ambiguous or edited screenshots do not auto-settle.",
    ],
  },
];
