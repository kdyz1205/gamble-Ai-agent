...
function compileSystemPrompt() {
  ...
  return `You are stubborn, an AI challenge protocol compiler.
...
function compileFastSystemPrompt() {
  const nowIso = new Date().toISOString();
  return `You are stubborn. Compile the user's challenge into SHORT JSON only. Current time: ${nowIso}.
