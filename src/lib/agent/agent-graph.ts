...
export const AGENT_READINESS: Record<AgentNodeId, AgentReadiness> = {
  ...
  challenge_creator: {
    ...
    evidence: ["src/app/api/challenges/route.ts", "src/lib/agent/tools.ts:createChallengeTool", "scripts/e2e-agent-compile-publish.mjs", "scripts/e2e-agent-golden-path.mjs", ".github/workflows/production-agent-protocol-chain.yml"],
  ...
  evidence_intake: {
    ...
    evidence: ["src/app/api/challenges/[id]/evidence/route.ts", "src/app/api/uploads/evidence-presign/route.ts", "scripts/e2e-agent-golden-path.mjs", "scripts/e2e-video-winner-settlement.mjs", "scripts/e2e-real-video-robustness.mjs", ".github/workflows/production-agent-protocol-chain.yml", ".github/workflows/production-video-robustness.yml"],
  ...
  outcome_judge: {
    status: "partial",
    summary: "Production robustness E2E proves OpenAI vision outcome judging for generated phone-style push-up fixtures, valid winner settlement, and no-auto-settle gates for unclear/invalid/tied/video-cheat cases.",
    evidence: ["src/app/api/challenges/[id]/judge/route.ts", "src/lib/ai-engine.ts", "scripts/e2e-video-winner-settlement.mjs", "scripts/e2e-real-video-robustness.mjs", ".github/workflows/production-video-e2e.yml", ".github/workflows/production-video-robustness.yml"],
    missing: ["Arbitrary real human phone videos are still not proven reliable across real-world bodies, angles, lighting, camera motion, and occlusion."],
  ...
  settlement_gate: {
    ...
    evidence: ["src/lib/judgment-policy.ts", "src/lib/protocol-judgment-policy.ts", "src/app/api/challenges/[id]/judge/route.ts", "scripts/e2e-agent-settlement-chain.mjs", "scripts/e2e-agent-review-path.mjs", "scripts/e2e-real-video-robustness.mjs", ".github/workflows/production-agent-protocol-chain.yml", ".github/workflows/production-video-robustness.yml"],
  ...
  credit_settlement: {
    ...
    evidence: ["src/lib/credits.ts:settleChallenge", "src/app/api/challenges/[id]/confirm-verdict/route.ts", "scripts/e2e-agent-golden-path.mjs", "scripts/e2e-data-source-oracle-settlement.mjs", "scripts/e2e-gps-checkin-settlement.mjs", "scripts/e2e-video-winner-settlement.mjs", ".github/workflows/production-agent-protocol-chain.yml", ".github/workflows/production-video-e2e.yml"],
